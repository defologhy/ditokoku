                                                            ...
                                                            <div class="delivery-address-box">
                                                                <div>
                                                                    ...
                                                                    <ul class="delivery-address-detail">
                                                                        <li>
                                                                            <h4 class="fw-500">Nama Penerima</h4>
                                                                        </li>

                                                                        <li>
                                                                            <p class="text-content"><span class="text-title">Alamat
                                                                                : </span>Jalan Setapak no 1</p>
                                                                        </li>
                                                                        ...
                                                                        <li>
                                                                            <h6 class="text-content mb-0"><span class="text-title">No Hp
                                                                                :</span> 0831236521</h6>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                            ...
                            <div class="right-side-summery-box">
                                <div class="summery-box-2">
                                    <div class="summery-header">
                                        <h3>Produk Yang Di Order</h3>
                                    </div>

                                    <ul class="summery-contain">
                                        <li>
                                            <img src="/images/vegetable/product/1.png" class="img-fluid blur-up lazyloaded checkout-image" alt="" />
                                            <h4>Bell pepper <span>X 1</span></h4>
                                            <h4 class="price">$32.34</h4>
                                        </li>

                                        <li>
                                            <img src="/images/vegetable/product/2.png" class="img-fluid blur-up lazyloaded checkout-image" alt="" />
                                            <h4>Eggplant <span>X 3</span></h4>
                                            <h4 class="price">$12.23</h4>
                                        </li>

                                        <li>
                                            <img src="/images/vegetable/product/3.png" class="img-fluid blur-up lazyloaded checkout-image" alt="" />
                                            <h4>Onion <span>X 2</span></h4>
                                            <h4 class="price">$18.27</h4>
                                        </li>

                                        <li>
                                            <img src="/images/vegetable/product/4.png" class="img-fluid blur-up lazyloaded checkout-image" alt="" />
                                            <h4>Potato <span>X 1</span></h4>
                                            <h4 class="price">$26.90</h4>
                                        </li>

                                        <li>
                                            <img src="/images/vegetable/product/5.png" class="img-fluid blur-up lazyloaded checkout-image" alt="" />
                                            <h4>Baby Chili <span>X 1</span></h4>
                                            <h4 class="price">$19.28</h4>
                                        </li>

                                        <li>
                                            <img src="/images/vegetable/product/6.png" class="img-fluid blur-up lazyloaded checkout-image" alt="" />
