...
function Cart(props) {
    ...
    const handleDirectPageCheckout = async () => {
                                        ...
                                        <tbody>
                                            <tr class="product-box-contain">
                                                <td class="product-detail">
                                                    <div class="product border-0">
                                                        <a href="product-left-thumbnail.html" class="product-image">
                                                            <img src="/images/vegetable/product/1.png" class="img-fluid blur-up lazyloaded" alt="" />
                                                        </a>
                                                ...
                                                <td class="save-remove">
                                                    <h4 class="table-title text-content">Opsi</h4>
                                                    {/* <a class="save notifi-wishlist" href="javascript:void(0)">Save for later</a> */}
                                                    <a class="remove close_button" href="javascript:void(0)">Hapus</a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="product-box-contain">
                                                <td class="product-detail">
                                                    <div class="product border-0">
                                                        <a href="product-left-thumbnail.html" class="product-image">
                                                            <img src="/images/vegetable/product/2.png" class="img-fluid blur-up lazyloaded" alt="" />
                                                        </a>
                                                        <div class="product-detail">
                                                            <ul>
                                                                <li class="name">
                                            ...
                                            <tr class="product-box-contain">
                                                <td class="product-detail">
                                                    <div class="product border-0">
                                                        <a href="product-left-thumbnail.html" class="product-image">
                                                            <img src="/images/vegetable/product/3.png" class="img-fluid blur-up lazyloaded" alt="" />
                                                        </a>
                                                        <div class="product-detail">
                                                            <ul>
                                                                <li class="name">
                        ...
                        <div class="col-xxl-3">
                            <div class="summery-box p-sticky">
                                ...
                                <div class="button-group cart-button">
                                    <ul>
                                        <li>
                                            <Link href='#' onClick={handleDirectPageCheckout} class="btn btn-animation proceed-btn fw-bold">Checkout</Link>
                                        </li>

                                        <li>
                                            <Link href='#' class="btn btn-light shopping-button text-dark">
                                                <i class="fa-solid fa-arrow-left-long"></i> &nbsp; Belanja Lagi</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
